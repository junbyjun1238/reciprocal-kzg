...
Experimental reciprocal-folding PoC notes for this workspace live at [docs/reciprocal_poc.md](docs/reciprocal_poc.md).
The current core paper PDF is available at [docs/core_paper/reciprocal_fold_note.pdf](docs/core_paper/reciprocal_fold_note.pdf).
